...
import com.saeyan.controller.action.BoardListPagingAction;
import com.saeyan.controller.action.BoardSearchListPagingAction;
...
import com.saeyan.controller.action.DemoAction;
...
public class ActionFactory {
	...
	public Action getAction(String command) {
		...
		if (command.equals("board_list")) {
			...
			action = new BoardListPagingAction(); // 페이징 지원 액션으로 변경
		...
		}else if (command.equals("board_search_list")) {
			action = new BoardSearchListPagingAction();
		}
		return action;
	}
}
